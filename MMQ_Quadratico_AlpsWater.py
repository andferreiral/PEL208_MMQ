...
def predicao(pressao):
    #crio uma matriz (1x3) com o valor do viés e o valor informado
    A = pd.DataFrame([[1, pressao, pressao * pressao]])[:].values
...
print('O valor de pressao predito é : %.2f' %(predicao(200)))
