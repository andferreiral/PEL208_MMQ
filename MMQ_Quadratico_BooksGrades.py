...
#crio uma coluna com os valores da variavel dependente quadrática
db['x2'] = db['Books'] * db['Books']

#crio uma coluna com os valores da variavel dependente quadrática
db['xx2'] = db['Attend'] * db['Attend']
...
def predicao(books,attend):
    ...
    A = pd.DataFrame([[1, books, attend]])[:].values
...
#TESTE
print('O valor de nota predito é : %.2f' %(predicao(4, 18)))