...
for i in range(len(db['boiling'])):
    somatoria += (db['boiling'][i] - media) ** 2
...
def predicao(pressao):
    #crio uma matriz (1x2) com o valor do peso e o valor informado
    A = pd.DataFrame([[peso, pressao]])[:].values
